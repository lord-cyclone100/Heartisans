          ...
          {wallet ? (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Main Balance Card */}
                <div className="md:col-span-2 bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl shadow-xl p-8 text-white">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 border border-green-100">
                  ...
                  <div className="space-y-4">
                    <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-4 rounded-xl font-semibold text-base sm:text-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105">
                      Withdraw Funds
                    </button>
                    <button className="w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-gray-200 transition-all duration-300">
                      Add Bank Account
                    </button>
                    <button className="w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-gray-200 transition-all duration-300">
                      Download Statement
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg sm:text-xl font-semibold text-green-600">Verified</p>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-red-200 text-center">
              ...
              <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-8 rounded-xl font-semibold text-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-300">
                Contact Support
              </button>
            </div>
          )}
